 ...
 * @author MASTER
 */
public class PagamentoCartaoDebitoFuncionario extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PagamentoCartaoDebitoFuncionario.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
